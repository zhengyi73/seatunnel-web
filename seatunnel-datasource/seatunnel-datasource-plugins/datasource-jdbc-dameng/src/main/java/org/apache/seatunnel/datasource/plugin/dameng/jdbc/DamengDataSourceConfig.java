...
public class DamengDataSourceConfig {
    ...
    public static final DataSourcePluginInfo DAMENG_DATASOURCE_PLUGIN_INFO =
    ...
    public static final Set<String> DAMENG_SYSTEM_DATABASES =
            Sets.newHashSet("SYS", "SYSDBA", "SYSAUDITOR", "SYSSSO", "CTISYS");
